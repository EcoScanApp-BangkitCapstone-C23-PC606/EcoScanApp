...
import com.dicoding.econscan.databinding.ActivityCameraBinding
import com.dicoding.econscan.utils.createFile
...
class CameraActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.setTitle("EcoScan")
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                ...
                override fun onImageSaved(output: ImageCapture.OutputFileResults) {
                    ...
                    val mainIntent = Intent(this@CameraActivity, MainActivity::class.java).apply {
                        putExtras(bundle)
                    }
